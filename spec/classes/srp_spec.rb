...
describe 'mofed::srp' do
  on_supported_os.each do |os, facts|
    context "when #{os}" do
      ...
      it do
        is_expected.to contain_service('srpd').with(ensure: 'running',
                                                    enable: 'true',
                                                    hasstatus: 'true',
                                                    hasrestart: 'true',
                                                    require: 'Package[srptools]',)
      ...
      context 'when ports defined' do
        ...
        it do
          is_expected.to contain_service('srpd').with(ensure: 'stopped',
                                                      enable: 'false',
                                                      hasstatus: 'true',
                                                      hasrestart: 'true',
                                                      require: 'Package[srptools]',)
        ...
        if facts[:operatingsystemrelease].to_i >= 7.0
          ...
          it do
            is_expected.to contain_service('srpd@1').with(ensure: 'running',
                                                          enable: 'true',
                                                          hasstatus: 'true',
                                                          hasrestart: 'true',
          ...
          it do
            is_expected.to contain_service('srpd@2').with(ensure: 'running',
                                                          enable: 'true',
                                                          hasstatus: 'true',
                                                          hasrestart: 'true',
                                                          require: ['File[/etc/modprobe.d/ib_srp.conf]'],
